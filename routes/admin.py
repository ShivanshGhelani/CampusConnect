...
# from .admin.auth import router as admin_auth_router  # Commented out - using main auth system
...
# router.include_router(admin_auth_router)  # Commented out - using main auth system
