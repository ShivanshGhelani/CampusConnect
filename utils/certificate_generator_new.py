...
class CertificateGenerator:
    ...
    async def generate_and_download_certificate(
        ...
        try:
            ...
            if not self._is_eligible_event(event):
                return False, "Certificate generation is under development for this event type", None
    ...
    def _is_eligible_event(self, event: Dict) -> bool:
        ...
        event_mode = event.get('mode', '').lower()
        
        return event_type == 'free' and event_mode == 'individual'
    ...
    def _get_template_path(self, event: Dict) -> Optional[Path]:
        ...
        template_path = self.templates_dir / certificate_template
